...
public class SwitchPerspective : MonoBehaviour
{
    ...
    [SerializeField]
    private Perspective perspective = Perspective.ThirdPerson;
    ...
    {
        containerNameByPerspective.Add(Perspective.FirstPerson, ContainerName.Container1P);
        containerNameByPerspective.Add(Perspective.ThirdPerson, ContainerName.Container3P);
