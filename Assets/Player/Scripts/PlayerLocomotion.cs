...
public class PlayerLocomotion : MonoBehaviour
{
    ...
    void SetCurrentCamera()
    {
        ...
        if (switchPerspective.GetPerspective() == SwitchPerspective.Perspective.FirstPerson)
        {
    ...
    void PerspectiveCheck()
    {
        if (Input.GetKeyDown(KeyCode.Tab))
        {
            ...
            if (switchPerspective != null)
            {
                if (switchPerspective.GetPerspective() == SwitchPerspective.Perspective.FirstPerson)
                {
                    switchPerspective.SetPerspective(SwitchPerspective.Perspective.ThirdPerson);
                }
                else
                {
                    switchPerspective.SetPerspective(SwitchPerspective.Perspective.FirstPerson);
                }
